alter table {table_name} alter column commercialdev set data type varchar;
alter table {table_name} alter column jointdev set data type varchar;
...
update {table_name} set offer_date = make_date(2023,month(cast(offer_date as timestamp)),day(cast(offer_date as timestamp))) where year(cast(offer_date as timestamp)) > 2023;
...
alter table {table_name} alter column offer_date set data type timestamp;
...
alter table {table_name} alter column client_description set data type varchar;
alter table {table_name} alter column legal_status set data type varchar;
alter table {table_name} alter column read_details set data type varchar;
alter table {table_name} alter column rollup_y_n set data type varchar;
alter table {table_name} alter column offer_lead_id set data type int;
